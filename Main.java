...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("Sanyam Sharma");
        alert.setContentText("In programming, if someone tells you " +
                " you’re overcomplicating it,"+
                " they're either 10 steps behind you or 10 steps ahead of you.");
